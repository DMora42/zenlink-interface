...
import { config } from '@grass-protocol/wagmi'
import { WagmiConfig } from 'wagmi'
import { ThemeProvider } from 'next-themes'
import { App, ToastContainer } from '@grass-protocol/ui'
import { Provider } from 'react-redux'
import { configureStore } from '@reduxjs/toolkit'
import { DefaultSeo } from 'next-seo'
import { parachains } from '@grass-protocol/polkadot-config'
import { PolkadotApiProvider } from '@grass-protocol/polkadot'
import { LanguageProvider, storage, storageMiddleware } from '@grass-protocol/shared'
