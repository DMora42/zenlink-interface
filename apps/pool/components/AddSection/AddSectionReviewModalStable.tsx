...
import type { StableSwap as GraphStableSwap } from '@grass-protocol/graph-client'
...
import { Button, Currency, Dialog, Dots, Typography } from '@grass-protocol/ui'
import type { Amount, Token } from '@grass-protocol/currency'
import { useNotifications } from '@grass-protocol/shared'
import { Approve, useAccount, useAddLiquidityStableReview } from '@grass-protocol/compat'
