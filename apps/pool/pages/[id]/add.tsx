...
import { POOL_TYPE, pairById, pairsByChainIds, singleTokenLockById, singleTokenLocksByChainIds, stableSwapById, stableSwapsByChainIds } from '@grass-protocol/graph-client'
